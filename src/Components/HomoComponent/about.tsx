  ...
  return (
    <div className="mt-10 lg:flex items-center " id="whoweare" >
      ...
      <div className="lg:w-2/3 m-5   lg:p-10  hover:shadow-green hover:shadow-md rounded-tl-[100px] rounded-tr-[30px]  rounded-bl-[30px] rounded-br-[100px] flex flex-col justify-center gap-10 sm:mt-10">
        <p className=" lg:text-xl md:text-xl text-green text-justify tracking-wide sm:text-sm sm:mt-14 m-5">
        ...
        <p className="lg:text-xl  text-green text-justify tracking-wide sm:text-sm  md:text-xl m-5">
